...
class Flight_Round_Trip2 extends StatefulWidget {
  const Flight_Round_Trip2({super.key});

  @override
  State<Flight_Round_Trip2> createState() => _userDashboardState();
}

class _userDashboardState extends State<Flight_Round_Trip2> {
                                                    ...
                                                    Column(
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Text('Departure Flight Details                ',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.black
                                                              ),),

                                                              // Text(OnwardJourney_carrierCodeArray[index].toString(),style: TextStyle(fontSize: 14,fontWeight: FontWeight.w300,color: Colors.black
                                                              // ),),
                                                              Text(OnwardJourney_DeptimeArray[index].toString() + '-------------------------> ' + OnwardJourney_ArrivaltimeArray[index],style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.black
                                                              ),),
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Text('Return Flight Details                     ',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.black
                                                              ),),
                                                              ...
                                                              // Text(Retrived_Rndtrp_Destinationiatacodestr[index].toString(),style: TextStyle(fontSize: 14,fontWeight: FontWeight.w300,color: Colors.black
                                                              // ),),
                                                              Text(OnwardJourney_arrivaliataCodelist[index].toString() + '           '+ segmentValuesAraycnt[index] + ' ' + 'Segments' +'             '+  OnwardJourney_depiataCodelist[index].toString(),style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color: Colors.black
                                                              ),),
