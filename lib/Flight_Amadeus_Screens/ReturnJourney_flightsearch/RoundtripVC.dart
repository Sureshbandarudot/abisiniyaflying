...
class Round_tripJourneyVC extends StatefulWidget {
  String classstr = '';
...
class _FlightSearchVCState extends State<Round_tripJourneyVC> with SingleTickerProviderStateMixin {
  String classstr = '';
            ...
            child: TabBar(
              //controller: _tabController,
                ...
                tabs: [
                  ...
                  Tab(
                    child: Text(
                      Retrived_Rndtrp_iatacodestr + '  -  ' + Retrived_Rndtrp_Destination_iatacodestr,
                      style: TextStyle(
                  ...
                  Tab(
                    child: Text(
                      Retrived_Rndtrp_Destination_iatacodestr + '  -  ' + Retrived_Rndtrp_iatacodestr,
                      style: TextStyle(
                        //fontFamily: kFontFamily,
                        fontSize: 16,
                        fontWeight: FontWeight.w800,
