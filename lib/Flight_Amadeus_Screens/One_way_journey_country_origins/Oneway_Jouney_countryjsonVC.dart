...
class Oneway_OriginCountryVC extends StatefulWidget {
...
class _HomePageState extends State<Oneway_OriginCountryVC> {
  ...
  Future<dynamic> OriginlocationAPI() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        for (Map user in jsonData) {
          _countryDetails.add(CountryDetails.fromJson(user as Map<String, dynamic>));
        ...
        return new Card(
          child: new ListTile(
              ...
              onTap: () async{
                ...
                SharedPreferences prefs = await SharedPreferences.getInstance();
                prefs.setString("Oneway_origincitykey", oneway_trpcontroller.text);
                prefs.setString("Oneway_origincountry_codekey", Country_code);
                prefs.setString("Oneway_originCountry_namekey", Country_name);
